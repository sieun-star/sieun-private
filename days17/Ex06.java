...
public class Ex06 {
	...
	public static void main(String[] args) {
		 ...
		 *    double PI = 3.14;         public final static 을 함께 선언하지 않아도 앞에 생략된것이다.                                
		 *    [public final static] double PI = 3.14;                     
		 *    
		 *    인터페이스 안의 메서드는 모두 추상메서드...
		 *    void test();   public abstract를 함께 선언하지 않아도 생략된것으로 간주. 
...
abstract class Unit{
	...
	int x; // 현재 유닛의 위치(x 좌표)
	int y; // 현재 유닛의 위치(y 좌표)
}
...
// 군인
// 클래스 선언할 때 인터페이스를 구현한다 : implements 키워드 사용
