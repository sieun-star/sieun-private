...
public class Ex06_02 {
	...
	public static void main(String[] args) {
		 ...
		 *                 데이터를 빠르게 검색할 수 있다.
		 *   - 데이터저장(key+value) 키를 해시 함수에 넣으면 배열의 한 요소를 얻어오고 
		 *     다시 그 곳에 연결된 링크드 리스트에 데이터를 저장.   
		 *                
		 *   - 해싱을 사용하기 때문에 많은 양의 데이터를 검색하는 데 뛰어난 성능이 있다.   
		 *   
		 *   
		 *   
		...
		*/
		...
		// String value = ht.get("kenik");  // null
	...
	private static void dispHT(HashMap<String, String> ht) {
		...
		while (ir.hasNext()) {
			Entry<java.lang.String, java.lang.String> entry =  ir.next();
