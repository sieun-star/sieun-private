...
public class Ex07 {
	...
	public static void main(String[] args) {
		 ...
		 * 5. 열거형 -> 클래스로 컴파일되어진다. -> 부모클래스 extends java.lang.Enum 클래스
		 * 6. Enum 클래스
		 *   1)  ordinal() : 열거형 상수가 정의된 순서를 반환
		 *   2)  name() : 열거형 상수명 이름 문자열로 반환    
		...
		System.out.println(Gender.valueOf("MAN"));  // == Gender.MAN
		System.out.println(Gender.valueOf("MAN").ordinal());  
		System.out.println(Gender.valueOf("MAN").name());  
